...
const translations = {
  ...
  "add.voteRecorded": { ru: "Ваш голос учтён!", sgh: "Ваш голос учтён!" },
  "add.netVotes": { ru: "У этого слова теперь", sgh: "У этого слова теперь" },
  "add.netVotesUnit": { ru: "голосов (нетто)", sgh: "голосов (нетто)" },
  "add.sessionSummary": { ru: "Вы проверили", sgh: "Вы проверили" },
  "add.wordsUnit": { ru: "слов", sgh: "слов" },
  "add.closeToApproval": { ru: "из них близки к одобрению!", sgh: "из них близки к одобрению!" },
  "add.wordAutoApproved": { ru: "Это слово автоматически одобрено!", sgh: "Это слово автоматически одобрено!" },
  "add.rateLimited": { ru: "Слишком быстро! Подождите немного.", sgh: "Слишком быстро! Подождите немного." },
